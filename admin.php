...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
            ...
            <nav class="sidebar-menu">
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="item_info.php" target="frmbody">Item Add</a></li>
                            <li><a  href="catagorey_add.php" target="frmbody" >Catagorey Add</a></li>
                            <li><a  href="sub_catagorey_add.php" target="frmbody">Sub Catagorey Add</a></li>
                            <li><a  href="brand_add.php" target="frmbody">Brand Add</a></li>
                            <li><a  href="product_add.php" target="frmbody">Product Add</a></li>
        ...
        <main class="main-content">
            ...
            <iframe src="item_info.php" height="100%" width="1118" name="frmbody"> </iframe>
