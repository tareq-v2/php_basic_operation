            ...
            <div class="container-fluid">
                ...
                <div class="form-wrappper">
                    <div class="add-view-btn">
                       ...
                       <input type="submit" name="sub_menu_view_btn" class="btn btn-secondary" value="View"> 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_menu_serialNumber" class="form-control" placeholder="Add Route Name">
                    </div>
                    <div class="form-group">
