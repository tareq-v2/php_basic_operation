                ...
                <ul id="nav-accordion">
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a  href="main_menu_add.html">Main Menu</a></li>
                            <li><a  href="sub_menu_add.html">Sub Menu</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a  href="slider_add.html">Slider</a></li>
                            <li><a  href="offer_banner_add.html">Offer Banner</a></li>
                            <li><a  href="faq_add.html">FAQ</a></li>
                            <li><a  href="customer_message_add.html">Customer Message</a></li>
                            <li><a  href="career_info.html">Career Info</a></li>
                            <li><a  href="cod_add.html">Cash on Delivery</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a  href="catagorey_add.html">Catagorey Add</a></li>
                            <li><a  href="sub_catagorey_add.html">Sub Catagorey Add</a></li>
                            <li><a  href="brand_add.html">Brand Add</a></li>
                            <li><a  href="product_add.html">Product Add</a></li>
                            <li><a  href="view_all_products.html">View All Product</a></li>
                        </ul>
                    </li>
                   ...
                   <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="add_product_stock.html">Add Product Stock</a></li>
                            <li><a  href="view_stock.html">View Stock</a></li>
                            <li><a  href="stock_report.html">Stock Report</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="seller_register.html">Seller Register</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="view_review.html">View Review</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="guest_information.html">Guest Information</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="deliver_charge_add.html">Delivery Charge Add</a></li>
                            <li><a  href="shipping_class.html">Shipping Class</a></li>
                            <li><a  href="district_add.html">District Setup</a></li>
                            <li><a  href="thana_add.html">Thana Setup</a></li>
                            <li><a  href="zone_add.html">Zone Add</a></li>
                            <li><a  href="zone_wise_district.html">Zone Wise District</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="cuopon_add.html">Cuppon Add</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="pending_order.html">Pending Order</a></li>
                            <li><a  href="process_order.html">Process Order</a></li>
                            <li><a  href="onthe_way_order.html">On the Way Order</a></li>
                            <li><a  href="complete_order.html">Complete Order</a></li>
                            <li><a  href="reject_order.html">Reject Order</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a  href="offer_add.html">Offer Add</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="btn-primary.html">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-sm-6">
...
<!-- Mirrored from mosaddek.com/theme/diverse/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jul 2020 06:47:43 GMT -->
</html>
